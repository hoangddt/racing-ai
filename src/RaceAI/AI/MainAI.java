...
public class MainAI {
	...
	public void AI(){
		...
		// AI example
		//Block Index
		this.writeLogMsg("Value of key is: ===============================>" + key);
		int x = (int) (this.Mycar.getx() / this.race.BlockSize());
		int y = (int) (this.Mycar.gety() / this.race.BlockSize());
		
		this.writeLogMsg("Mycar.getX and Mycar.getY: " + this.Mycar.getx() + ", "+ this.Mycar.gety());
		this.writeLogMsg("x and y value after cast: " + x + ", "+ y);
		this.writeLogMsg("race.BlockSize() is: " + this.race.BlockSize());
		...
		this.writeLogMsg("Speed and speed_now: " + speed + ", " + speed_now);
